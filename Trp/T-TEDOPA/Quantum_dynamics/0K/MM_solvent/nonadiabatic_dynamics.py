...
def main():
    ...
    energy_1 = 0.18251842472389965
    energy_2 = 0.17774680461351478
    coupling = 0.0005764837697113354
    mu_01 = 0.41970081629127354
    mu_02 = 0.8583370818972874
    ...
    num_fock_1_high = [50]
    num_fock_1_low = 50
    num_fock_2_high = [220, 220, 220, 100, 100, 100, 80, 80, 60, 60]
    num_fock_2_low = 50
    num_fock_12_high = [10]
    num_fock_12_low = 10
    ...
    savedir = os.getcwd()
    coeffsdir = os.path.join(savedir, "chain_coeffs_0K.hdf5")
