...
PHASE123_PARAMS = Phase123Config(
    system=SystemConfig(
        energy_1=0.1665144661778894,
        energy_2=0.17644,
        coupling=0.001981777702161172,
        mu_01=0.7585262192321821,
        mu_02=1.7481083485475297,
        temp=300.0,
    ),
    chain=ChainConfig(
        chain_length_1=250,
        chain_length_2=250,
        chain_length_12=250,
        num_fock_1_high=[60,100,80,60,50],
        num_fock_1_low=40,
        num_fock_2_high=[40],
        num_fock_2_low=30,
        num_fock_12_high=[30],
    ...
    bond_taper=BondTaperConfig(
        ...
        bond_dim_12_large=100,
        bond_dim_12_small=60,
