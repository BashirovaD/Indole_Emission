...
PHASE123_PARAMS = Phase123Config(
    system=SystemConfig(
        energy_1=0.18413156545143,
        energy_2=0.192584,
        coupling=0.00035947371444708723,
        mu_01=0.45387538500368824,
        mu_02=0.9187403041297787,
        temp=300.0,
    ),
    chain=ChainConfig(
        chain_length_1=250,
        ...
        num_fock_1_high=[50],
        num_fock_1_low=50,
        num_fock_2_high=[100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 80, 80, 60, 60, 60],
        num_fock_2_low=40,
        num_fock_12_high=[40],
        num_fock_12_low=40,
    ),
    bond_taper=BondTaperConfig(
        bond_dim_1_large=120,
        bond_dim_1_small=50,
        bond_sigmoid_center_1=0.0,
        bond_sigmoid_sharpness_1=6.0,
        bond_dim_2_large=120,
        bond_dim_2_small=80,
        bond_sigmoid_center_2=0.0,
        bond_sigmoid_sharpness_2=6.0,
        bond_dim_12_large=120,
        bond_dim_12_small=80,
